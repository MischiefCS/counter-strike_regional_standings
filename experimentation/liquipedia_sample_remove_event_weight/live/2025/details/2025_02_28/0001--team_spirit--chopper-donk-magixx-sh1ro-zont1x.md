...
Global Rank: [1](../../standings_global_2025_02_28.md)<br />
<br />
Region: [Europe]( ../../standings_europe_2025_02_28.md)<br />
Regional Rank: [1]( ../../standings_europe_2025_02_28.md)<br />
<br />
Final Rank Value:  1970.0<br />
<br />
Final Rank Value (1970.0) = Starting Rank Value (1998.7) + Head To Head Adjustments (-28.7)<br />

#### Starting Rank Value<br />
To figure out a rosters's Starting Rank Value, first take the average of these four factors:<br />
- Bounty Offered: 1.000[<sup>1</sup>](#table2)
- Bounty Collected: 0.718[<sup>2</sup>](#table1)
- Opponent Network: 0.487[<sup>2</sup>](#table1)
- LAN Wins: 1.000[<sup>2</sup>](#table1)

The average of these factors is 0.801<br />
<br />
Next, take the maximum and minimum average across all teams and compute the following:<br />
- 400 + ( ( Roster_Average - Min_Average ) / ( Max_Average - Min_Average ) ) * 1600 = 1998.7
- 400 + ( ( 0.801 - 0.000 ) / ( 0.802 - 0.000 ) ) * 1600 = 1998.7
...
| -: | -: | :- | :- | :- | :- | :- | :- | :- | :- | -: | :- |
|           33 |      524 | 2025-02-09 | Team Vitality     | L   | 1.000      | -            | -                | -                | -         |   -16.84 | chopper, donk, magixx, sh1ro, zont1x |
|           32 |      579 | 2025-02-08 | Natus Vincere     | W   | 1.000      | 1.000        | 0.613 (0.613)    | 0.464 (0.464)    | 1 (1.000) |     9.01 | chopper, donk, magixx, sh1ro, zont1x |
|           31 |      670 | 2025-02-07 | Virtus.pro        | W   | 1.000      | 1.000        | 0.292 (0.292)    | 0.440 (0.440)    | 1 (1.000) |     5.26 | chopper, donk, magixx, sh1ro, zont1x |
|           30 |      771 | 2025-02-04 | GamerLegion       | W   | 1.000      | 1.000        | -                | 0.448 (0.448)    | 1 (1.000) |     3.47 | chopper, donk, magixx, sh1ro, zont1x |
|           29 |      779 | 2025-02-04 | Team Liquid       | W   | 1.000      | -            | -                | -                | 1 (1.000) |     0.70 | chopper, donk, magixx, sh1ro, zont1x |
|           28 |      789 | 2025-02-03 | Natus Vincere     | L   | 1.000      | -            | -                | -                | -         |   -23.26 | chopper, donk, magixx, sh1ro, zont1x |
|           27 |      806 | 2025-02-02 | Astralis          | W   | 1.000      | 1.000        | 0.719 (0.719)    | 0.839 (0.839)    | 1 (1.000) |    11.52 | chopper, donk, magixx, sh1ro, zont1x |
|           26 |      912 | 2025-01-26 | Eternal Fire      | W   | 0.979      | 1.000        | 0.699 (0.684)    | 0.548 (0.536)    | 1 (0.979) |    13.71 | chopper, donk, magixx, sh1ro, zont1x |
|           25 |      919 | 2025-01-25 | Natus Vincere     | W   | 0.973      | 1.000        | 0.613 (0.597)    | 0.464 (0.451)    | 1 (0.973) |     8.36 | chopper, donk, magixx, sh1ro, zont1x |
|           24 |      973 | 2025-01-23 | HEROIC            | W   | 0.959      | 1.000        | 0.156 (0.149)    | 0.433 (0.415)    | 1 (0.959) |     1.01 | chopper, donk, magixx, sh1ro, zont1x |
|           23 |     1041 | 2025-01-18 | FlyQuest          | W   | 0.926      | -            | -                | -                | -         |     0.24 | chopper, donk, magixx, sh1ro, zont1x |
|           22 |     1056 | 2025-01-14 | Fnatic            | W   | 0.900      | 1.000        | -                | 0.528 (0.475)    | -         |     0.88 | chopper, donk, magixx, sh1ro, zont1x |
